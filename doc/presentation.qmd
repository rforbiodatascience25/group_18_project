...
#### how
By recreating the visualizations and analyses provided in the @Maciejewski2024 study, uing the same data and our own R implementations.
...
- Cox-based risk prediction model with high (Q3) relative to low (Q1) expression of each HDAC family members.
